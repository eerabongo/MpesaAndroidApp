...
import com.esau.mpesatrial.Config;
import com.esau.mpesatrial.MainActivity;
import com.esau.mpesatrial.Utils;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void handleDataMessage(JSONObject json) {
        ...
        try {
            ...
            if (!Utils.isAppIsInBackground(getApplicationContext())) {
                ...
                Utils notificationUtils = new Utils(getApplicationContext());
    ...
    private void showNotificationMessage(Context context, String title, String message, String timeStamp, Intent intent) {
        notificationUtils = new Utils(context);
